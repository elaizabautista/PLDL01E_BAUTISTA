...
class LoginPage:
    def __init__(self, root):
        ...
        self.google_button = tk.Button(self.root, text="Google", font=("Comic Sans MS", 12), bg="#FFB6C1", fg="white", bd=0, relief="solid", width=15, command=self.social_login)
        self.google_button.place(relx=0.4, rely=0.8, anchor="center")

        self.facebook_button = tk.Button(self.root, text="Facebook", font=("Comic Sans MS", 12), bg="#FFEC99", fg="white", bd=0, relief="solid", width=15, command=self.social_login)
    ...
    def social_login(self):
        messagebox.showinfo("Social Media Login", "You have selected a social media login option!")
